...
const embeddingsList_1 = require("../embeddingsList");
...
describe('EmbeddingsList', () => {
    ...
    beforeAll(() => {
        ...
        embeddingsList = new embeddingsList_1.EmbeddingsList(mockModel, 'dense', mockEmbeddings, mockUsage);
    });
    ...
    test('Should return correct Embedding by index and by element', () => {
        ...
        const elementToFindIndexOf = mockEmbeddings[0];
...
describe('truncateData', () => {
    ...
    test('Should truncate output of data object when appropriate', () => {
        ...
        embeddingsList = new embeddingsList_1.EmbeddingsList(mockModel, 'dense', mockEmbeddingsWithoutTruncationExpected, mockUsage);
    ...
    test('should truncate data correctly when there are more than 5 embeddings', () => {
        const mockEmbeddingsWithTruncationExpected = [
        ...
        embeddingsList = new embeddingsList_1.EmbeddingsList(mockModel, 'dense', mockEmbeddingsWithTruncationExpected, mockUsage);
        const expectedTruncatedData = [
            { values: [1, 2, '...', 4, 5] },
            { values: [6, 7, '...', 9, 10] },
            `... (2 more embeddings) ...`,
