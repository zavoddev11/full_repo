...
import type { ChatOptions, ContextOptions, ListFilesOptions, UploadFileOptions } from './data/types';
...
export declare class Assistant {
     ...
     */
    chatCompletion(options: ChatOptions): Promise<import("..").ChatCompletionModel>;
    /**
     ...
     */
    chatCompletionStream(options: ChatOptions): Promise<import("./chatStream").ChatStream<import("./data/types").StreamedChatCompletionResponse>>;
    /**
